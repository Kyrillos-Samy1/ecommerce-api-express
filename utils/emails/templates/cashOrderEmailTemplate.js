...
<head>
  ...
  <style>
    body { background: linear-gradient(135deg, #d9d9d9, #bfbfbf); font-family: "Segoe UI", Arial, sans-serif; margin:0; padding:0; color:#333; }
    .container { max-width:700px; width:95%; margin:20px auto; background-color:#f5f5f5; border-radius:16px; overflow:hidden; box-shadow:0 8px 20px rgba(0,0,0,0.1); }
    .header table { width:100%; border-collapse:collapse; } .header h1 { margin:0; font-size:22px; } .header img { display:block; border-radius:50%; border:2px solid #fff; max-width:100%; height:auto; }
    .content { padding:20px; text-align:center; } table { width:100%; border-collapse:collapse; margin-top:20px; font-size:14px; } th, td { padding:8px; text-align:center; word-wrap:break-word; } th { background-color:#bfbfbf; color:#333; } .total { margin-top:20px; font-size:18px; font-weight:bold; text-align:left;} .footer { background-color:#d0d0d0; color:#555; text-align:center; padding:15px; font-size:12px; }
    @media only screen and (max-width:600px) { .header td { display:block; text-align:center; } .header td img { margin:10px auto; } th, td { padding:6px; font-size:12px; } .content { padding:15px; } .total { font-size:16px; } }
  </style>
</head>
<body>
  <div class="container">
